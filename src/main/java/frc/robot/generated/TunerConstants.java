...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(50).withKI(0).withKD(1)
        .withKS(0.1).withKV(0.05).withKA(0)//2.66
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.1).withKI(0).withKD(0)
        .withKS(0).withKV(0.05);//0.124
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.3388671875);
    private static final boolean kFrontLeftSteerMotorInverted = true;
    private static final boolean kFrontLeftEncoderInverted = false;

    private static final Distance kFrontLeftXPos = Inches.of(10.35);
    private static final Distance kFrontLeftYPos = Inches.of(10.35);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.1787109375);
    private static final boolean kFrontRightSteerMotorInverted = true;
    private static final boolean kFrontRightEncoderInverted = false;

    private static final Distance kFrontRightXPos = Inches.of(10.35);
    private static final Distance kFrontRightYPos = Inches.of(-10.35);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.437255859375);
    private static final boolean kBackLeftSteerMotorInverted = true;
    private static final boolean kBackLeftEncoderInverted = false;

    private static final Distance kBackLeftXPos = Inches.of(-10.35);
    private static final Distance kBackLeftYPos = Inches.of(10.35);
    ...
    private static final Distance kBackRightYPos = Inches.of(-10.35);
